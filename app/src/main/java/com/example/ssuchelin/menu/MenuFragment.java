...
import com.example.ssuchelin.R;
import com.example.ssuchelin.menu.week.DateAdapter;
...
//        menuText1 = findViewById(R.id.menuText1);
//        menuText2 = findViewById(R.id.menuText2);
//        menuText3 = findViewById(R.id.menuText3);
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new CalendarAdapter(getDaysOfMonth(currentCalendar));
